 ...
 * @RouteBody      null
 */
router.get("/video/render/:link", async (req, res) => {
  if (Object.keys(req.params).indexOf("link") === -1) {
    res.json({ error: "Sorry! video ID is not provided or initialized!" });
    return;
  }

  log.info("Video is start rendering");
